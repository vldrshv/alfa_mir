package com.filechooser.internals;
...
public class FileUtil {
    ...
    static String getExtensionWithoutDot(File file) {
    ...
    private static long readSDCard(Context context, Boolean isRemovable, Boolean freeOrTotal) {
    ...
    private static boolean createNewDirectory(String name, File parent) {
    ...
    public static class NewFolderFilter implements InputFilter {
        ...
        NewFolderFilter(int maxLength, String pattern) {
