...
public final class EventLogger implements Player.EventListener, AudioRendererEventListener,
    ...
    public void onTracksChanged(TrackGroupArray ignored, TrackSelectionArray trackSelections) {
        ...
        Log.d(TAG, "Tracks [");
        // Logger tracks associated to renderers.
        for (int rendererIndex = 0; rendererIndex < mappedTrackInfo.length; rendererIndex++) {
            ...
            if (rendererTrackGroups.length > 0) {
                ...
                // Logger metadata for at most one of the tracks selected for the renderer.
        ...
        // Logger tracks not associated with a renderer.
