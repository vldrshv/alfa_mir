 ...
 * - The invoking activity must onCallClicked VideoEnabledWebChromeClient's onBackPressed() inside of its own onBackPressed().
...
public class VideoEnabledWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
     ...
     * @param activityVideoView A ViewGroup in the activity's layout that will display the video. Typically you would onLikeClicked this to fill the whole layout.
     */
    @SuppressWarnings("unused")
